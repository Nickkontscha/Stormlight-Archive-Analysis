---
title: "Additional analysis of the Stormlight Archive"
output: 
...
<br>
<br>
```{r c1, echo=FALSE, fig.align='center', fig.height=10, fig.width=10}
c1
```
<br>
<br>
```{r c2, echo=FALSE, fig.align='center', fig.height=10, fig.width=10}
c2
```
<br>
<br>
```{r c1_tfidf, echo=FALSE, fig.align='center', fig.height=10, fig.width=10}
c1_tfidf
```
<br>
<br>
```{r c2_tfidf, echo=FALSE, fig.align='center', fig.height=10, fig.width=10}
c2_tfidf
```
